    ...
    return (
        <div className="bg-[#D3E1FC] dark:bg-[#1e3a5f] border-b px-4 py-1 flex gap-4 items-center justify-between border-2 border-[#C3CFE8] dark:border-[#2d4a6b] rounded-md transition-colors">
            ...
            <div className="flex items-center gap-4">
                <a href="/" onClick={handleHomeClick} className="p-1.5 rounded transition cursor-pointer">
                    <svg
            ...
            <form onSubmit={handleSearch} className="flex justify-end gap-2 w-full max-w-md">
                ...
                <button 
                    type="submit"
                    className="text-gray-700 dark:text-gray-200 px-4 py-1 rounded-md hover:bg-gray-600 hover:text-white dark:hover:bg-gray-600 font-medium border-2 border-gray-500 dark:border-gray-600 transition-colors cursor-pointer"
                >
                    Search
                </button>
            </form>
